...
fun CepScreen() {
    ...
    var listaEnderecoState by remember {
        mutableStateOf(listOf<Endereco>())
    }

    var listaCepState by remember {
    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text(
                    text = "Encontre o seu endereço", fontSize = 20.sp
                )
                ...
                Spacer(modifier = Modifier.height(32.dp))
                Text(
                    text = "Não sabe o CEP?", fontWeight = FontWeight.Bold
                )
                Spacer(modifier = Modifier.height(8.dp))
                Row {
                    OutlinedTextField(value = ufState, onValueChange = {
                        ufState = it
                    }, modifier = Modifier
                        .weight(1f)
                    ...
                    Spacer(modifier = Modifier.height(8.dp))
                    OutlinedTextField(value = cidadeState, onValueChange = {
                        cidadeState = it
                    }, modifier = Modifier.weight(2f), label = {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    OutlinedTextField(value = ruaState, onValueChange = {
                        ruaState = it
                    }, modifier = Modifier.weight(2f), label = {
